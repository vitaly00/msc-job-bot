...
async def create(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.message.reply_text("Inserisci nome nave (MSC ...):")
    return NAME
...
async def get_name(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not name.startswith("MSC"):
        await update.message.reply_text("❌ La nave deve iniziare con MSC")
        return NAME
...
async def get_end(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ LAVORO CREATO")
...
async def list_jobs(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cursor.execute("""
        SELECT name, start, location, terminal
        FROM jobs
